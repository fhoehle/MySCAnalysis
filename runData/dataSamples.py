dataDatasets = {
  'SingleMu__Run2011A-PromptReco-v6__AOD':{
    ...
    ,"crabConfig":{"CMSSW":{"number_of_jobs":1500,"lumi_mask":'singleMuRun2011A_all.txt',"total_number_of_lumis" : -1}}
  ...
  ,'SingleMu__Run2011B-PromptReco-v1__AOD':{
    ...
    ,"color":0
    ,"crabConfig":{"CMSSW":{"number_of_jobs":1500,"lumi_mask":'Cert_160404-180252_7TeV_PromptReco_Collisions11_JSON.txt',"total_number_of_lumis" : -1}}
